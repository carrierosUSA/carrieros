...
function isProtectedAppPath(pathname: string): boolean {
  ...
  return ["/alerts","/analytics","/brokers","/claims","/compliance","/dispatch","/documents","/driver","/drivers","/expenses","/finance","/fleet","/ifta","/maintenance","/nova","/payroll","/profitability","/settings","/api/documents"].some(
