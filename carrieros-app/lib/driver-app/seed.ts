...
function seedConnections(): ConnectedService[] {
  ...
  return [
    ...
    { id: "c-maint", category: "maintenance", name: "Shop work orders", provider: "Transpo.ai Shop", connected: true, lastSyncAt: sync },
    { id: "c-banks", category: "banks", name: "Driver pay card", provider: "WEX Bank", connected: false, statusNote: "Connect to view advances" },
    { id: "c-payroll", category: "payroll", name: "Settlements", provider: "Transpo.ai Payroll", connected: true, lastSyncAt: sync },
