...
export const seedDrivers: Driver[] = [
  {
    ...
    status: "active",
    phone: "210-555-0001",
    photoUrl: "https://i.pravatar.cc/88?u=onkar-singh",
    location: "San Antonio, TX",
    homeTerminal: "San Antonio Terminal",
    hireDate: "2019-03-15",
    truckId: "truck-102",
    licenseClass: "CDL A",
    ...
    drugTestDueAt: "2027-01-15",
    annualReviewDueAt: "2027-03-15",
    lastInspectionAt: "2026-02-10",
    hoursRemaining: 6.5,
    payRate: 0.58,
    payType: "per_mile",
  ...
  },
  {
    ...
    status: "active",
    phone: "210-555-0002",
    photoUrl: "https://i.pravatar.cc/88?u=lovepreet-kaur",
    location: "San Antonio, TX",
    homeTerminal: "San Antonio Terminal",
    hireDate: "2021-08-01",
    licenseClass: "CDL A",
    ...
    drugTestDueAt: "2026-11-01",
    annualReviewDueAt: "2026-08-01",
  ...
  },
  {
    ...
    id: "marcus-reed",
    name: "Aman Singh",
    email: "aman.singh@demo-carrier.com",
    role: "Company Driver",
    status: "onboarding",
    phone: "210-555-0003",
    photoUrl: "https://i.pravatar.cc/88?u=marcus-reed",
    location: "Austin, TX",
    homeTerminal: "Austin Yard",
    hireDate: "2026-06-20",
    licenseClass: "CDL A",
    ...
    drugTestDueAt: "2026-08-15",
    annualReviewDueAt: "2027-06-20",
    hoursRemaining: 11,
    payRate: 0.52,
    payType: "per_mile",
  ...
  },
  {
    ...
    status: "active",
    phone: "512-555-0044",
    photoUrl: "https://i.pravatar.cc/88?u=carlos-mendez",
    location: "Houston, TX",
    homeTerminal: "Houston Terminal",
    hireDate: "2022-04-12",
    licenseClass: "CDL A",
    licenseNumber: "TX-CDL-441902",
    licenseState: "TX",
    licenseExpiresAt: "2026-08-20",
    medicalExpiresAt: "2026-07-30",
    drugTestDueAt: "2026-07-25",
    annualReviewDueAt: "2026-04-12",
    lastInspectionAt: "2024-06-01",
    hoursRemaining: 2.5,
    payRate: 0.55,
    payType: "per_mile",
    novaSummary: "Experienced driver with expiring compliance documents.",
  ...
  },
  {
    ...
    id: "sarah-johnson",
    name: "Sarah Johnson",
    email: "sarah.johnson@demo-carrier.com",
    role: "Company Driver",
    status: "inactive",
    phone: "210-555-0055",
    photoUrl: "https://i.pravatar.cc/88?u=sarah-johnson",
    location: "San Antonio, TX",
    homeTerminal: "San Antonio Terminal",
    hireDate: "2020-01-08",
    licenseClass: "CDL A",
    licenseNumber: "TX-CDL-339812",
    licenseState: "TX",
    licenseExpiresAt: "2027-11-15",
    medicalExpiresAt: "2027-06-01",
    payRate: 0.54,
    payType: "per_mile",
    novaSummary: "Currently off duty — approved leave.",
    createdAt: "2020-01-08T09:00:00Z",
...
export const seedDriverDocuments: DriverDocument[] = [
  ...
  },
  {
    ...
    type: "ssn",
    status: "valid",
    uploadedAt: "2019-03-15T10:00:00Z",
    secured: true,
  },
  {
    tenantId: DEMO_TENANT_ID,
    ...
    type: "drug_test",
    status: "valid",
    uploadedAt: "2019-03-20T10:00:00Z",
  },
  {
    tenantId: DEMO_TENANT_ID,
  ...
  },
  {
    ...
    type: "cdl",
    status: "expiring",
    uploadedAt: "2022-04-12T10:00:00Z",
    expiresAt: "2026-08-20",
  },
  {
    tenantId: DEMO_TENANT_ID,
    id: "doc-carlos-medical",
    driverId: "carlos-mendez",
    name: "Medical Card",
    type: "medical",
    status: "expiring",
...
export const seedDriverViolations: DriverViolation[] = [
  {
    tenantId: DEMO_TENANT_ID,
    id: "violation-carlos-1",
    driverId: "carlos-mendez",
    title: "Speeding — 72 in 65",
    description: "Citation received on I-10 near Sealy, TX.",
    occurredAt: "2026-05-14T14:30:00Z",
    severity: "minor",
    status: "resolved",
  },
  {
    tenantId: DEMO_TENANT_ID,
    id: "violation-onkar-1",
    driverId: "onkar-singh",
    title: "Logbook Form & Manner",
    description: "Minor logbook violation noted during roadside inspection.",
    occurredAt: "2026-03-02T09:15:00Z",
    severity: "minor",
    status: "resolved",
  },
];

export const seedDriverNotes: DriverNote[] = [
  {
    tenantId: DEMO_TENANT_ID,
    id: "note-onkar-1",
    driverId: "onkar-singh",
    author: "Lovepreet Kaur",
    body: "Prefers morning dispatches. Excellent on reefer loads.",
  ...
  },
  {
    ...
    driverId: "marcus-reed",
    author: "Safety Team",
    body: "Complete orientation checklist before first solo dispatch.",
...
export const driverViolationStore: DriverViolation[] = structuredClone(seedDriverViolations);
export const driverNoteStore: DriverNote[] = structuredClone(seedDriverNotes);
