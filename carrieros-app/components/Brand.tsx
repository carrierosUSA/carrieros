export default function Brand() {
  return (
    <div className="flex items-center gap-3">
      <div className="relative grid h-11 w-11 place-items-center rounded-2xl bg-white shadow-xl shadow-blue-950/20">
      ...
      <div>
        <h1 className="text-lg font-semibold tracking-tight text-white">CarrierOS</h1>
