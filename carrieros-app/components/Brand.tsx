...
type BrandProps = {
  /** When true, always show name + tagline (expanded sidebar). */
  showLabels?: boolean;
};

export default function Brand({ showLabels = false }: BrandProps) {
  return (
    <div
      className={`flex w-full min-w-0 items-center gap-3 ${
        showLabels ? "justify-start" : "justify-center lg:group-hover/sidebar:justify-start"
      }`}
    >
